...
app.page.receive("icon", function (e) {
  app.button.icon(e.tabId, e.data);
});
...
app.interface.receive("disable", function () {
  app.tab.query.active(function (tab) {
    app.page.send("disable", null, tab.id, null);
  });
});

app.interface.receive("enable", function () {
  app.tab.query.active(function (tab) {
    app.page.send("enable", null, tab.id, null);
  });
});
